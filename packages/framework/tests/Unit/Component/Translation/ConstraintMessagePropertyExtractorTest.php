...
{
    public function testExtractFromConstraint(): void
    {
        $file = new SplFileInfo(__DIR__ . '/MyConstraintClass.php');
    ...
    public function testExtractFromOtherClass(): void
    {
        $file = new SplFileInfo(__DIR__ . '/MyOtherClass.php');
